...
namespace Web_2.Migrations
{
    ...
    [Migration("20241011191809_Update_24")]
            ...
            modelBuilder.Entity("Web_2.Models.Delivery.delivery", b =>
                {
                    ...
                    b.Property<int>("shipperidshipper")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Web_2.Models.Delivery.delivery", b =>
                {
                    ...
                    b.HasOne("Web_2.Models.Delivery.shipper", null)
                        .WithMany()
                    ...
                    b.HasOne("Web_2.Models.Delivery.shipper", "shipper")
                        .WithMany()
                        .HasForeignKey("shipperidshipper")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_2.Models.Thanhtoan.ThanhToan", null)
                        .WithMany()
                        .HasForeignKey("thanhtoanid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
